...
@pytest.mark.need_review
@pytest.mark.xfail (reason="Ожидаемопадающий тест, так как уведомление присутсвует на странице корзины")
...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        ...
        email = " "
        password = " "
        page.register_new_user(browser, email, password)
    #  проверка, что регистрация совершилась успешно
        page.should_be_message_after_registration()
